...
# build flags
CFLAGS=-O0 -g -ffreestanding -Wall -Wextra -DDEBUG -DARCH_MEMCPY -DARCH_MEMMOVE -DARCH_MEMSET -DARCH_MEMSET16 -DARCH_MEMSET32 -DTERM_VGATEXT -DKINIT_MM_FIRST -DKSTDERR_SER -DFEAT_PCI -DFEAT_ACPI_LAI
